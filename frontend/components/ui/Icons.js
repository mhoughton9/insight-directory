// Icons.js - A collection of SVG icons as React components
 ...
 */
export const PodcastIcon = ({ size = 24, className = '' }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
 ...
 * App icon
 */
export const AppIcon = ({ size = 24, className = '' }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
...
export const MeditationIcon = ({ size = 24, className = '' }) => (
  <svg 
    ...
    className={className}
  >
    <path d="M12 2a5 5 0 0 1 5 5v9a5 5 0 0 1-10 0V7a5 5 0 0 1 5-5Z"></path>
    <path d="M8 15v1a4 4 0 0 0 8 0v-1"></path>
    <path d="M17 7h1a4 4 0 0 1 0 8h-1"></path>
    <path d="M7 7H6a4 4 0 0 0 0 8h1"></path>
  </svg>
);

/**
 * Home/retreat center icon
 */

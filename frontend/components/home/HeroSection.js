...
const HeroSection = () => {
  return (
    <section className="py-10 md:py-16 px-4 max-w-6xl mx-auto text-center">
      <h1 className="text-4xl md:text-4xl lg:text-5xl mb-4 tracking-tight text-black" style={{ fontFamily: 'Lora, serif' }}>
        <span className="text-black">Awakening</span> Directory
      </h1>
      ...
      <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-3 max-w-2xl mx-auto" style={{ fontFamily: 'Inter, sans-serif' }}>
        Creating an account is free and allows you to save your favorite resources, leave comments, and write reviews to help others on their journey.
      </p>
    </section>
  );
};

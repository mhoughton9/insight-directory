 ...
 * Displays external links for a tradition
 * @param {Object} props - Component props
 * @param {Object} props.tradition - Tradition data object
 */
const TraditionDetailSidebarLinks = ({ tradition }) => {
  if (!tradition) return null;
  
  // Get links from tradition data
  const links = tradition.links || [];
...
export default TraditionDetailSidebarLinks;
